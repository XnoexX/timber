...
int main() {	// argc - number of arguments | argv - array of pointers to strings
	...
	// Prepare 6 branches
	Texture textureBranch; textureBranch.loadFromFile("..\\graphics\\branch.png");
	...
	chopBuffer.loadFromFile("..\\sound\\chop.ogg");
	Sound chop;
	...
	ootBuffer.loadFromFile("..\\sound\\out_of_time.flac");
	Sound outOfTime;
